  ...
  const manejarEnvio = async (e) => {
    ...
    try {
      ...
      if (modo === "agregar") {
        ...
        setTimeout(() => navigate('/productos'), 100);
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '15px' }}>
        ...
        />
        {errores.nombre && <p style={{ color: 'red', fontSize: '14px' }}>{errores.nombre}</p>}
      </div>
      ...
      {/* Avatar */}
      <div style={{ marginBottom: '15px' }}>
        <label style={{ fontWeight: 'bold' }}>Imagen (URL):</label>
        <input
          type="text"
          name="avatar"
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        />
        {errores.descripcion && (
          <p style={{ color: 'red', fontSize: '14px' }}>{errores.descripcion}</p>
        )}
      </div>
